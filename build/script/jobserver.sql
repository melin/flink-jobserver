...
CREATE TABLE `fjs_job_instance` (
  ...
  `runtime_mode` varchar(32)  NOT NULL COMMENT '运行模式: batch & stream',
...
CREATE TABLE `fjs_flink_driver` (
  ...
  `schedule_type` varchar(45)  DEFAULT NULL COMMENT '作业计算类型：yarn_batch、yarn_stream、k8s_batch、k8s_stream',
