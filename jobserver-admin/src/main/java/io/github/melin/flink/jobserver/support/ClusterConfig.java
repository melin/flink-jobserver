...
public class ClusterConfig implements InitializingBean {
    ...
    public String getDriverHadoopUserName(String clusterCode) {
        String user = System.getProperty(FlinkJobServerConf.JOBSERVER_DRIVER_HADOOP_USER_NAME.getKey());
        if (StringUtils.isBlank(user)) {
            user = this.getValue(clusterCode, FlinkJobServerConf.JOBSERVER_DRIVER_HADOOP_USER_NAME);
        }
